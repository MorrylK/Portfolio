...
export const categoryData: Record<keyof typeof translations.en.categories, CategoryData> = {
    'ai-data': {
        ...
        projects: [
            ...
            {
                title: 'Blender & Unity Documentation Chatbot',
                titleFr: 'Chatbot de Documentation Blender & Unity',
                description: 'Specialized conversational AI chatbot trained on Blender and Unity documentation for 3D creation and gaming. Uses RAG (Langchain, Qdrant vector DB, PostgreSQL, BAAI/bge-m3 embeddings, llama-3.1-8b-instant model, Groq API) with a Next.js frontend and FastAPI backend.',
